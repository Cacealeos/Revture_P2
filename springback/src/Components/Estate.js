...
const Estate = () => {
    ...
    const REQUEST_APPOINTMENT_DESTINATION = "http://localhost:8080/appointments";
    ...
    async function CreateAppointment() {
        ...
        const response = await fetch(REQUEST_APPOINTMENT_DESTINATION ,{
    ...
    async function DeleteAppointment() {
        ...
        const response = await fetch(REQUEST_APPOINTMENT_DESTINATION.concat(showEstate.ID) ,{
        ...
        <div className="EstateSelector">
            ...
            <div  className="Estate">
                <div className="displayEstate">
                    ...
                    {showEstate.clientId && <div className="createAppointBtn " onClick={() => DeleteAppointment(showEstate.ID)}>
                        Remove Appointment
                        <ImQuill></ImQuill>
                    </div>}

                    {showEstate.realtorId && <div className="createAppointBtn " onClick={() => DeleteListing(showEstate.ID)}>
                        Remove Listing
                        <ImQuill></ImQuill>
                    </div>}
